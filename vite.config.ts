...
export default defineConfig(({ command }) => {
  // Before anything else: a Vercel production build with no Supabase vars
  // would ship a bundle that boots into offline seed mode, silently. Fail
  // here, where it is still a red deploy rather than a live outage.
