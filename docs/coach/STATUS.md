...
| A04 | Rich confirm cards: before/after preview per tool call | A | in review (#344) — green, mergeable, next in the babysitter | `feat/coach-confirm-preview` | owns `ChatSidebar.tsx` this wave |
...
## Next up
1. Shane is landing wave A (#341–#343 merged 17:22 UTC; #344 next).
...
- 2026-09-25 · Shane · merged #341, #342, #343; main at `706cbad`.
