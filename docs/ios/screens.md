...
| `MobileBottomNav` FAB (+) → Workout / Meal | "+" in the navigation bar is a menu (Add workout / Add meal since W10), "Add workout" on an empty day, long-press a month cell → the builder | W7 | |
