...
//     that file could grant unattended. The agent must never be able to merge
//     an expansion of what the agent may do. Note this holds whether or not a
//     grant currently exists: .claude/settings.json carries only hook wiring
//     today, and the reason to hold these paths is that editing them is how a
//     grant would arrive.
